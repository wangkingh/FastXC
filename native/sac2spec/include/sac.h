/*************************************************************************
 ...
 Note:
 2016/07/01  WangWT change  unused11 and used12 to scmpaz and scmpinc to
             set cmpaz and cmpinc for source,i.e 1st station for output
             NCF in sac format.
             This actually do not affect others
**************************************************************************/
...
typedef struct sac_head
{
  ...
  /* wangwt change unused11 to scmpaz and unused12 to scmpinc
   * just for set noise cross correlation function.
   * wangwt@20160701 */
  float scmpaz;  /*    reserved for future use. Wangwt used to store cmpaz  of 1st station in NCF */
  float scmpinc; /*    reserved for future use  Wangwt used to store cmpinc of 1st station in NCF */
...
extern "C"
{
  ...
  /* Add to here by wang jingxi@ 2023 0722*/
